...
export default class Vaccine extends Component {
  ...
  async getV_amount(drizzle) {
    const m_amount = await drizzle.contracts.MedPass.methods
      .getV_amount("Moderna")
      .call();
    const p_amount = await drizzle.contracts.MedPass.methods
      .getV_amount("Pfizer")
      .call();
    const az_amount = await drizzle.contracts.MedPass.methods
      .getV_amount("AstraZeneca")
      .call();
    this.setState({
      m_amount: m_amount,
      p_amount: p_amount,
